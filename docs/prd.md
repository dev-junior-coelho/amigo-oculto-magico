...
- Teste1: Verificar se algoritmo de sorteio gera pares únicos (cada Receiver aparece apenas uma vez)
...
- Teste 4: Testar embaralhamento com diferentes tamanhos de grupos (3, 5, 10, 50participantes)
...
### 7.3 Deploy da Aplicação no Vercel
